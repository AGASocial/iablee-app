  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 px-4 sm:px-0">
          <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
            <h1 className="font-heading text-2xl xs:text-3xl sm:text-5xl md:text-6xl lg:text-7xl">
        ...
        <section className="container space-y-6 py-8 md:py-12 lg:py-24 px-0 sm:px-4">
          <div className="mx-auto grid gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3 grid-cols-1 px-4 sm:px-0">
      ...
      <footer className="border-t py-6 md:py-0 px-4 sm:px-0">
